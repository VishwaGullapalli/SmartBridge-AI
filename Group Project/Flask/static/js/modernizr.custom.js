...
(window.Modernizr = (function (a, b, c) {
  ...
  Modernizr.addTest("cssscrollbar", function () {
    var a,
      b =
        ...
        "scrollbar{width:0px}";
    return (
      Modernizr.testStyles(b, function (b) {
  ...
  Modernizr.addTest(
    "shapes",
    Modernizr.testAllProps("shapeOutside", "content-box", !0)
  );
